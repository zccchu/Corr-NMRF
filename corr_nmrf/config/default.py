...
_CN.NMP.NMP_TYPE = "swin"
_CN.NMP.REFINE_NMP_TYPE = "swin"  # "swin" | "corr_nmrf"
_CN.NMP.TTT_RANK = 8
_CN.NMP.TTT_BASE_LR = 1.0
_CN.NMP.TTT_MINI_BATCH_SIZE = 16
_CN.NMP.TTT_MAX_CHUNKS = 32
_CN.NMP.TTT_HARD_TOKEN_RATIO = 0.5
_CN.NMP.TTT_USE_SPATIAL_FUSION = True
_CN.NMP.TTT_FUSION_KERNELS = [1, 3, 5]
_CN.NMP.TTT_DROPOUT = 0.0
_CN.NMP.TTT_USE_DIAG = True
_CN.NMP.TTT_TARGET_MODE = "epipolar"
_CN.NMP.TTT_STOP_GRAD_TARGET = True
_CN.NMP.TTT_USE_CONFIDENCE_WEIGHT = True
_CN.NMP.TTT_USE_RESIDUAL = True
_CN.NMP.TTT_EPIPOLAR_TARGET_STYLE = "split_ln"
_CN.NMP.TTT_CORR_LAMBDA = 0.5
_CN.NMP.TTT_LOSS_TYPE = "smooth_l1"
_CN.NMP.TTT_SMOOTH_L1_BETA = 1.0
_CN.NMP.TTT_ROUTER_LOSS_WEIGHT_CONF = True

# Proposal propagation type used by the WHU Corr-NMRF configuration.
_CN.NMP.PROP_TYPE = "cswin"
...
_CN.DATASETS.TRAIN = ["whu_stereo"]
# List of dataset name for testing
_CN.DATASETS.TEST = ["whu_stereo_test"]
# Image gamma
...
_CN.DATASETS.SPATIAL_CROP = True
_CN.DATASETS.RANDOM_CROP = True
_CN.DATASETS.WHU_SPATIAL_CROP = None
_CN.DATASETS.WHU_RANDOM_CROP = None
_CN.DATASETS.DIVIS_BY = 8
_CN.DATASETS.WHU_ROOT = ""
_CN.DATASETS.WHU_STEREO_WITHGT_ROOT = ""
...
# Minimum disparity for metric computation mask
_CN.TEST.EVAL_MIN_DISP = [0]
...
# and access it with:
#
# from corr_nmrf.config import global_cfg
